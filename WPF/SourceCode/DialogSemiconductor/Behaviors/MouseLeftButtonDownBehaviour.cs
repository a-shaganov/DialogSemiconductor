...
{
    public sealed class MouseLeftButtonDownBehaviour
    {
        ...
        /// Конструктор
        /// </summary>
        static MouseLeftButtonDownBehaviour()
        {
            CommandProperty = DependencyProperty.RegisterAttached("Command", typeof(ICommand), typeof(MouseLeftButtonDownBehaviour), new UIPropertyMetadata(null, OnPropertyChanged));
            CommandParameterProperty = DependencyProperty.RegisterAttached("CommandParameter", typeof(Object), typeof(MouseLeftButtonDownBehaviour));
        }
        #endregion
        ...
        private static void OnPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                if (e.NewValue != null)
                    uie.MouseLeftButtonDown += uie_MouseLeftButtonDown;
                else
                    uie.MouseLeftButtonDown -= uie_MouseLeftButtonDown;
            }
        }
        ...
        /// <param name="e"></param>
        static void uie_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
