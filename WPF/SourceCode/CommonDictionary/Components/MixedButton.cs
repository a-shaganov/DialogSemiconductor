...
namespace CommonDictionary.Components
{
    ...
    public class MixedButton : System.Windows.Controls.Primitives.ToggleButton
    {
        ...
        static MixedButton()
        {
            ...
            IconHeightProperty = DependencyProperty.Register("IconHeight", typeof(double), typeof(MixedButton),
                new FrameworkPropertyMetadata(double.NaN));
            IconWidthProperty = DependencyProperty.Register("IconWidth", typeof(double), typeof(MixedButton),
                new FrameworkPropertyMetadata(double.NaN));
